1. Kết nối dây trên xe mô hình
Dựa trên thông tin trước đó, bạn đang dùng ESP32 thường (ESP-WROOM-32) + L298 để điều khiển xe, đồng thời lắp thêm OV7670 để nhận diện màu đỏ và kích hoạt động cơ bắn. Dưới đây là sơ đồ kết nối cơ bản:

Kết nối ESP32 với Driver L298 (Điều khiển động cơ xe)
ESP32	L298
...
Cảm biến ADXL345 dùng giao tiếp I2C, kết nối như sau:
...
D22	SCL
D21	SDA
Nếu bạn dùng SPI thay vì I2C, nối như sau:
